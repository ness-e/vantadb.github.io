...
export default class Input {
  ...
  update() {
    this.cursorVelocity.x = MathUtils.damp(this.cursorVelocity.x, 0, 3, this.time.delta);

    this.cursorVelocity.y = MathUtils.damp(this.cursorVelocity.y, 0, 3, this.time.delta);
  }
}
