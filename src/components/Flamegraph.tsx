...
const FRAMES: Frame[] = [
  { label: "pyo3_call", w: 100, children: [
    { label: "ffi_transfer", w: 92, children: [
      { label: "memory_pin", w: 40 },
      { label: "query_parse", w: 52, children: [
        { label: "lexer", w: 20 },
  ...
  { label: "wal_flush", w: 48, children: [
    { label: "crc32c", w: 28 },
    { label: "fsync", w: 16 },
  ]},
  { label: "index_merge", w: 60, children: [
