...
export function SwissArchSection() {
  ...
  return (
    <section className="swiss-arch-section">
        ...
        <div className="swiss-arch-grid">
          <div className="swiss-arch-content">
            <h2 className="swiss-arch-title">
              Three layers.<br />One file.
            </h2>
            <p className="swiss-arch-body">
              VantaDB stacks a SQL engine, an HNSW vector index, and a BM25
              full-text index in a single embedded binary. No IPC, no
              sockets, no network overhead.
            </p>
          ...
          <div className="swiss-arch-visual">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.6rem", color: "var(--steel)", letterSpacing: "0.05em" }}>
            ...
            <svg viewBox="0 0 400 240" className="swiss-blueprint-svg" aria-label="Database architecture diagram">
              {/* API Layer Box */}
              <rect
                x="20"
                y="15"
              ...
              {/* Connecting Lines 1 */}
              <line x1="80" y1="55" x2="80" y2="95" className={`swiss-blueprint-line ${activeLayer === "api" || activeLayer === "planner" ? "swiss-blueprint-line--active" : ""}`} />
              <line x1="320" y1="55" x2="320" y2="95" className={`swiss-blueprint-line ${activeLayer === "api" || activeLayer === "planner" ? "swiss-blueprint-line--active" : ""}`} />
              ...
              {/* Connecting Lines 2 */}
              <line x1="120" y1="135" x2="120" y2="175" className={`swiss-blueprint-line ${activeLayer === "planner" || activeLayer === "storage" ? "swiss-blueprint-line--active" : ""}`} />
              <line x1="280" y1="135" x2="280" y2="175" className={`swiss-blueprint-line ${activeLayer === "planner" || activeLayer === "storage" ? "swiss-blueprint-line--active" : ""}`} />
              ...
              <line x1="20" y1="5" x2="380" y2="5" stroke="var(--border)" strokeWidth="0.5" opacity="0.3" />
              <line x1="20" y1="235" x2="380" y2="235" stroke="var(--border)" strokeWidth="0.5" opacity="0.3" />
            </svg>
