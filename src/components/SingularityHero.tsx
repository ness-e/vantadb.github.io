  ...
  return (
    <div ref={sectionRef} className="hero-section" id="hero">
      ...
      <div className="hero-content">
        ...
        {/* Tagline */}
        <p className="hero-tagline animate-enter stagger-2">
          Cognitive memory that never forgets
        </p>

        {/* Description */}
        <p className="hero-p animate-enter stagger-3">
          Give your AI agents persistent memory with hybrid BM25&nbsp;+&nbsp;HNSW
          search, native GraphRAG relations, and crash-safe WAL durability.
          No servers. No config. One&nbsp;pip&nbsp;install.
        </p>
        ...
        <div className="cta-group animate-enter stagger-4">
          ...
          >
            ...
            <span className="btn-install-feedback">
              {copied ? "Copied!" : ""}
            </span>
          </button>
