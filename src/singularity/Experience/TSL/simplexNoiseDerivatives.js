...
const simplexNoiseDerivatives = /*#__PURE__*/ Fn(([v_immutable]) => {
  ...
  const dx = float(
    temp0
      .element(int(0))
      .mul(x0.x)
      .add(temp0.element(int(1)).mul(x1.x))
      .add(temp0.element(int(2)).mul(x2.x))
      .add(temp1.element(int(0)).mul(x3.x))
      .add(temp1.element(int(1)).mul(x4.x))
      .add(mmm0.element(int(0)).mul(p0.x))
      .add(mmm0.element(int(1)).mul(p1.x))
      .add(mmm0.element(int(2)).mul(p2.x))
      .add(mmm1.element(int(0)).mul(p3.x))
      .add(mmm1.element(int(1)).mul(p4.x)),
  ).toVar();
  const dy = float(
    temp0
      .element(int(0))
      .mul(x0.y)
      .add(temp0.element(int(1)).mul(x1.y))
      .add(temp0.element(int(2)).mul(x2.y))
      .add(temp1.element(int(0)).mul(x3.y))
      .add(temp1.element(int(1)).mul(x4.y))
      .add(mmm0.element(int(0)).mul(p0.y))
      .add(mmm0.element(int(1)).mul(p1.y))
      .add(mmm0.element(int(2)).mul(p2.y))
      .add(mmm1.element(int(0)).mul(p3.y))
      .add(mmm1.element(int(1)).mul(p4.y)),
  ).toVar();
  const dz = float(
    temp0
      .element(int(0))
      .mul(x0.z)
      .add(temp0.element(int(1)).mul(x1.z))
      .add(temp0.element(int(2)).mul(x2.z))
      .add(temp1.element(int(0)).mul(x3.z))
      .add(temp1.element(int(1)).mul(x4.z))
      .add(mmm0.element(int(0)).mul(p0.z))
      .add(mmm0.element(int(1)).mul(p1.z))
      .add(mmm0.element(int(2)).mul(p2.z))
      .add(mmm1.element(int(0)).mul(p3.z))
      .add(mmm1.element(int(1)).mul(p4.z)),
  ).toVar();
  const dw = float(
    temp0
      .element(int(0))
      .mul(x0.w)
      .add(temp0.element(int(1)).mul(x1.w))
      .add(temp0.element(int(2)).mul(x2.w))
      .add(temp1.element(int(0)).mul(x3.w))
      .add(temp1.element(int(1)).mul(x4.w))
      .add(mmm0.element(int(0)).mul(p0.w))
      .add(mmm0.element(int(1)).mul(p1.w))
      .add(mmm0.element(int(2)).mul(p2.w))
      .add(mmm1.element(int(0)).mul(p3.w))
      .add(mmm1.element(int(1)).mul(p4.w)),
  ).toVar();
