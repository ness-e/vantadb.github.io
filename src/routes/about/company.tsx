            ...
            <div className="comparison-split" style={{ marginTop: "2rem" }}>
              <div>
                <ul className="comparison-list">
                  <li>
                    <span className="icon-cross">✗</span> Pinecone: $70/mo + per-vector pricing
                  </li>
                  <li>
                    <span className="icon-cross">✗</span> Weaviate/Qdrant: server process + ops team
                  </li>
                  <li>
                    <span className="icon-cross">✗</span> SQLite + extensions: limited vector
                    support
                  </li>
                  <li>
                    <span className="icon-cross">✗</span> LanceDB: data model is a second thought
                  </li>
                </ul>
              </div>
              <div>
                <ul className="comparison-list">
                  <li>
                    <span className="icon-check">✓</span> VantaDB: one binary, zero ops, MIT license
                  </li>
                  <li>
                    <span className="icon-check">✓</span> SQL + vector + full-text in a single query
                  </li>
                  <li>
                    <span className="icon-check">✓</span> Embedded in your process — no network hop
                  </li>
                  <li>
                    <span className="icon-check">✓</span> Sub-millisecond hybrid search
                  </li>
                </ul>
              </div>
            </div>
