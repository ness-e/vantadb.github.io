    ...
    <>
      ...
      <main className="page-content">
          ...
          panels={[
            {
              ...
              content: (
                <div className="ss-panel-inner">
                  ...
                  <p className="ss-desc">
                    Full-text lexical search at 1.2ms p99 with 100% recall. No sidecars, no separate
                    indexing pipeline — the Rust engine embeds directly into your process.
                  </p>
                  <div className="ss-metrics">
                    <div className="ss-metric">
                      <span className="ss-metric-value">1.2ms</span>
                      <span className="ss-metric-label">p99 latency</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">100%</span>
                      <span className="ss-metric-label">BM25 recall</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">0</span>
                      <span className="ss-metric-label">external deps</span>
                    </div>
                  </div>
                </div>
              ),
              ...
              content: (
                <div className="ss-panel-inner">
                  ...
                  <p className="ss-desc">
                    ...
                    search. Supports up to 32K dimensions with 1KB fixed-size keys and
                    sub-millisecond query times.
                  </p>
                  <div className="ss-metrics">
                    <div className="ss-metric">
                      <span className="ss-metric-value">32K</span>
                      <span className="ss-metric-label">max dims</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">1KB</span>
                      <span className="ss-metric-label">fixed keys</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">&lt;1ms</span>
                      <span className="ss-metric-label">query p99</span>
                    </div>
                  </div>
                </div>
              ),
            },
            {
              ...
              content: (
                <div className="ss-panel-inner">
                  ...
                  <div className="ss-metrics">
                    <div className="ss-metric">
                      <span className="ss-metric-value">0.2ms</span>
                      <span className="ss-metric-label">hop recovery</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">Weighted</span>
                      <span className="ss-metric-label">edge relations</span>
                    </div>
                    <div className="ss-metric">
                      <span className="ss-metric-value">Multi-hop</span>
                      <span className="ss-metric-label">reasoning</span>
                    </div>
                  </div>
                </div>
              ),
                ...
                <div className="ss-panel-inner">
                  ...
                  <div className="ss-metrics">
                    <div className="ss-metric">
                      ...
                      <span className="ss-metric-label">checksum</span>
                    </div>
                    <div className="ss-metric">
                    ...
                    <div className="ss-metric">
                      <span className="ss-metric-value">Zero</span>
                      <span className="ss-metric-label">data loss</span>
                    </div>
                  </div>
                </div>
              ),
        ...
        >
          ...
          <svg aria-hidden="true" className="arch-pipeline-svg" viewBox="0 0 200 600" fill="none">
            <path
              d="M100 0 L100 600"
              stroke="var(--amber)"
              strokeWidth="0.5"
          ...
          <div className="section-split--z1">
            <div>
              ...
              <div className="reveal reveal-delay-3">
                <Link to="/architecture" className="cta-link nav-cta">
            ...
            <div className="reveal reveal-delay-2 arch-side-col">
              <div className="reveal--rel">
                <ArchCrossSection />
                <div className="anime-logo-deco">
                  <HNSWLayerIcon size={80} />
                </div>
              </div>
              <Flamegraph />
            </div>
        ...
        >
          ...
          <svg aria-hidden="true" className="eco-hub-svg" viewBox="0 0 400 400" fill="none">
            <circle
              cx="200"
              cy="200"
              r="80"
          ...
          <div className="section-split--z1">
            <div>
              ...
              <p className="section-sub reveal reveal-delay-2 section-sub--mb">
                ...
                connect via direct FFI bindings. No HTTP bridge, no sidecar process. Just import and
                query.
              </p>
              <div className="reveal reveal-delay-3">
                <Link to="/integrations" className="cta-link nav-cta">
                  Explore Ecosystem →
                </Link>
              </div>
            </div>
                  ...
                  <div key={i} className="glow-card">
                    <div className="int-card-inner">
                      <div className="int-card-row">
                        <div className="int-icon-box">{fw.icon}</div>
                        <div>
                          <div className="int-name">{fw.name}</div>
                          <div className="int-protocol">{fw.protocol}</div>
                        </div>
                      </div>
                      <div className="int-badge">
                        <span
                          className="status-dot"
                          style={{ background: i >= 4 ? "var(--warn)" : "var(--success)" }}
                        />
                        {i >= 4 ? "BETA" : "STABLE"}
                      </div>
                    </div>
          ...
          <div className="section-split">
            <div>
              ...
              <p className="section-sub section-sub--mb reveal reveal-delay-2">
                Persistent agent memory, local-first RAG pipelines, codebase intelligence, and edge
                environments with zero network footprint. One engine, every deployment.
              </p>
              <div className="reveal reveal-delay-3">
                <Link to="/use-cases" className="cta-link nav-cta">
              ...
              <div className="term-window section-frame">
                ...
                <div className="uc-featured-body">
                  <div className="uc-content">
                    ...
                    <p className="uc-desc">
                      Persistent conversation history for agent runtimes — survives restarts, no
                      external database.
                    </p>
                  </div>
                  {/* SVG data flow */}
        ...
        <section id="cta" aria-labelledby="cta-heading" className="cta-section section-frame">
